...
def insert_article(metadata,content,TableName = "ChinaTech"):
    ...
    cur.close()
    conn.close()   
def Chinamain(url = "https://www.chinadaily.com.cn/business/tech",TableName = "ChinaTech"):
...
async def script(url = "https://www.chinadaily.com.cn/business/tech",TableName ="ChinaTech"):
...
async def subscript(url ="https://www.chinadaily.com.cn/a/202502/18/WS67b44ba5a310c240449d5ea3.html",TableName ="ChinaTech"):
    async with async_playwright() as p:
